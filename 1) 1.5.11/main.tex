...
% \begin{align}
    ...
    b &= m+p \\\\
    \therefore 
    \myvec{0&0&1}\myvec{a\\b\\c} &= \myvec{1&1&0}\myvec{m\\n\\p}, \\
    \myvec{1&0&0}\myvec{a\\b\\c} &= \myvec{0&1&1}\myvec{m\\n\\p}, \\
    \myvec{0&1&0}\myvec{a\\b\\c} &= \myvec{1&0&1}\myvec{m\\n\\p},
\end{align}
adding these 3 equations (1), (2) and (3) gives:
\begin{align}
    % 2(m+n+p) &= a + b + c\\
    2\myvec{1&1&1}\myvec{m\\n\\p} &= \myvec{1&1&1}\myvec{a\\b\\c}\\
    \implies\myvec{1&1&1}\myvec{m\\n\\p} &= \frac{1}{2}\myvec{1&1&1}\myvec{a\\b\\c}\\
    % \implies m+n+p 
    % &= \frac{a+b+c}{2} \\
    % &= s \\
...
\begin{align}
    \therefore 
    \myvec{1&0&0}\myvec{m\\n\\p}&=\frac{1}{2}\myvec{-1&1&1}\myvec{a\\b\\c}\\
    \implies m&= \frac{\sqrt{74}+\sqrt{32}-\sqrt{122}}{2},\\\\
    \myvec{0&1&0}\myvec{m\\n\\p}&=\frac{1}{2}\myvec{1&-1&1}\myvec{a\\b\\c}\\
    \implies n&= \frac{\sqrt{74}+\sqrt{122}-\sqrt{32}}{2},\\\\
    \myvec{0&0&1}\myvec{m\\n\\p}&=\frac{1}{2}\myvec{1&1&-1}\myvec{a\\b\\c}\\
    \implies p&= \frac{\sqrt{122}+\sqrt{32}-\sqrt{74}}{2}
\end{align}
