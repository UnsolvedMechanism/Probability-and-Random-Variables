...
\begin{enumerate}
	\item Number of cards with value equal to 7($n_1$) = 4\\
		$\therefore$ Probability to find a card with value equal to 7 
		\begin{align}
			&= \frac{n_1}{N}\\
			&= \frac{4}{40}\\
			&=0.1
	...
	\item Number of cards with value greater than 7($n_2$) 
		...
		$\therefore$ Probability to find a card with value greater than 7
		\begin{align}
			&= \frac{n_2}{N}\\
			&= \frac{12}{40}\\
			&=0.3
	...
	\item Number of cards with value less than 7($n_3$)
		...
		$\therefore$ Probability to find a card with value lesser than 7 
		\begin{align}
			&= \frac{n_3}{N}\\
			&= \frac{24}{40}\\
			&=0.6
